...
public class JobFetcher {
    ...
    public void fetchJobs(
        ...
        while(true) {
            ...
            for (int pageNumber = jobFeedResponse.getPageNumber() + 1; pageNumber < totalPages; pageNumber++) {
                ...
                newestUpdatedDate = handleResponse(pageJobFeedResponse, dataBatchHandler);
            ...
            if (newestUpdatedDate == null || !newestUpdatedDate.isAfter(oldestUpdatedDate)) {
    ...
    private LocalDateTime handleResponse(JobFeedResponse jobFeedResponse, Consumer<List<JobAdDto>> dataHandler) {
    ...
    private String buildApiUrl(LocalDateTime now, LocalDateTime oldestUpdatedDate, LocalDateTime newestUpdatedDate) {
        return apiUrlForIT + "&published=(" + now.minusMonths(6) + "," + now + ")&updated=(" + oldestUpdatedDate + "," + newestUpdatedDate + ")";
    }
